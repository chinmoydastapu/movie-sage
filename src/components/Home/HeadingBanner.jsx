...
const images = [
    ...
    "https://cdn11.bigcommerce.com/s-ydriczk/images/stencil/1500x1500/products/90301/98769/the-creator-original-movie-poster-one-sheet-final-style-buy-now-at-starstills__81077.1697644483.jpg?c=2&imbypass=on",
    "https://creativereview.imgix.net/content/uploads/2023/12/Oppenheimer.jpg?auto=compress,format&q=60&w=1263&h=2000",
    "https://m.media-amazon.com/images/I/91uzbH0vmcL._AC_UF894,1000_QL80_.jpg",
                ...
                >
                    {images.map((image, index) => (
                        <SwiperSlide key={index}>
                            <div className="flex justify-center items-center w-full bg-cover h-[500px] lg:h-96 rounded-xl shadow-lg" style={{ backgroundImage: `url(${image})` }}>
                            </div>
                        </SwiperSlide>
                    ))}
                </Swiper>
