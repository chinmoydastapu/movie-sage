        ...
        <div className='bg-cover relative' style={{ backgroundImage: `url(${gridImage})` }}>
            ...
            <footer className="footer text-base-content p-10 relative">
                <aside>
                    ...
                    <p>
                        Movie Sage Industries Ltd.
                        <br />
                        Providing reliable review since 2024
                    </p>
                </aside>
                <nav>
            ...
            <footer className="footer text-neutral-content items-center p-4 relative">
                <div className="absolute inset-0 bg-black opacity-50"></div>
                <aside className="grid-flow-col items-center opacity-100 relative">
                    <svg
                        width="36"
                        height="36"
                        viewBox="0 0 24 24"
                    ...
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by Movie Sage Industries Ltd.</p>
                </aside>
